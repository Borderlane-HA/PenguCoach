...
SOURCE_NOTICE = (
    "Garmin summary fields are authoritative official activity totals when present. "
    "PenguCoach FIT analytics are locally calculated supplements. Missing values are null and must not be invented."
)
