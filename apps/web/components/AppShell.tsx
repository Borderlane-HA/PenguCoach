...
type IconName="today"|"health"|"activities"|"training"|"coach"|"garmin"|"privacy"|"appearance"|"ai"|"users";
...
export default function AppShell({children,title}:{children:React.ReactNode;title?:string}){
  ...
  const[me,setMe]=useState<Me|null>(null),[appearance,setAppearance]=useState<Appearance|null>(null);
